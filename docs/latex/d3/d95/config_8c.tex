\hypertarget{config_8c}{}\section{config/config.c File Reference}
...
\begin{center}
\leavevmode
\includegraphics[width=346pt]{da/ddd/config_8c__incl}
\end{center}
\end{figure}
...
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
07-\/11-\/2017 Operazioni sui file di configurazione 
\end{DoxyDate}
